...
<div class="p-6 max-w-4xl mx-auto">
  <div class="flex items-center gap-4 mb-6">
    ...
    <div>
      <h1 class="text-2xl font-bold">Create Coupon</h1>
      <p class="text-gray-500 mt-1">Create a new discount code</p>
    </div>
  </div>
  ...
  <div class="bg-white rounded-lg border p-6">
    <form on:submit|preventDefault={createCoupon} class="space-y-6">
      <!-- Code -->
      <div>
        ...
        <div class="flex gap-2">
          <input
            ...
            class="flex-1 px-4 py-2 border rounded-lg uppercase"
            maxlength={20}
          />
          <button
            type="button"
        ...
        <p class="text-sm text-gray-500 mt-1">Customers will enter this code at checkout</p>
      </div>
      ...
      <div class="border-t pt-6">
        <label class="flex items-center gap-3 cursor-pointer">
          ...
          <div>
            ...
            <p class="text-sm text-gray-500">Enable this coupon immediately</p>
          </div>
        </label>
      </div>
